            ...
            <div class="col-lg-12">
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <tr>
                        ...
                        <th>Supplier Pad Amount</th>
                        <th>Supplier Due Amount</th>
                        <th>Supplier Payment Method</th>
                        <th>Action</th>
                    </tr>
                    </thead>
                    <tbody>
                    @foreach($order_info as $value)
                        <tr>
                            ...
                            <td>{{ $value->customer_paid_amount }}</td>
                            <td>{{ $value->customer_due_amount }}</td>
                            <td>{{ $value->customer_due_pay_amount }}</td>
                            <td>{{ $value->customer_method_name }}</td>

                            <td>{{ $value->supplier_paid_amount }}</td>
                            <td>{{ $value->supplier_due_amount }}</td>
                            <td>{{ $value->supplier_due_pay_amount }}</td>
                            <td>{{ $value->supplier_method_name }}</td>
                            <td>
