...
@section('content')
    ...
    <section class="page-title" style="background-image:url({{asset('frontend/assets/images/background/8.jpg')}})">
        <div class="auto-container">
            <div class="content">
                <h3 style="color: #fff;">Mission <span>Vision</span></h3>
            ...
            <div class="row clearfix">
                ...
                <div class="video-column col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        ...
                        <div class="video-box">
                            <figure class="image">
                                <img src="{{asset($about_info[0]->mission_image)}}" alt="">
                            </figure>
                ...
                <div class="content-column col-lg-7 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <h3>{{$about_info[0]->mission_title}}</h3>
                        <div class="text" style="text-align: justify">
                            <?php echo $about_info[0]->mission_details ?? null;?>
                         </div>
                    </div>
                </div>
