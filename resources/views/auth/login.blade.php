...
{{--                                            <div class="d-grid">--}}
{{--                                                <a class="btn my-4 shadow-sm btn-white" href="{{ url('auth/google') }}"> <span class="d-flex justify-content-center align-items-center">--}}
{{--                                                    <span>Sign Up with Google</span>--}}
{{--											</span>--}}
{{--                                                </a> <a href="{{ url('auth/facebook') }}" class="btn btn-facebook"><i class="bx bxl-facebook"></i>Sign Up with Facebook</a>--}}
{{--                                            </div>--}}
                                        </div>
                                    </form>
                                </div>
