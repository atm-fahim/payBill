 ...
 * @since 2025-08-13
 */
class OurClientRepoImpl extends EloquentBaseRepository implements OurClientRepo
{
    protected $model;

    public function __construct(OurClientModel $model)
    {
        $this->model = $model;
    }
