...
use App\Repository\Backend\CustomerPaymentRepoImpl;
...
use App\Repository\Backend\PaymentOrderRepoImpl;
use App\Repository\Backend\PaymentReportsRepoImpl;
use App\Repository\Backend\RateRepoImpl;
use App\Repository\Backend\ServiceRepoImpl;
use App\Repository\Backend\SliderRepoImpl;
use App\Repository\Backend\SupplierPaymentRepoImpl;
...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(CustomerPaymentRepo::class, CustomerPaymentRepoImpl::class);
        ...
        $this->app->bind(PaymentOrderRepo::class, PaymentOrderRepoImpl::class);
        $this->app->bind(PaymentReportsRepo::class, PaymentReportsRepoImpl::class);
        $this->app->bind(RateRepo::class, RateRepoImpl::class);
        $this->app->bind(SupplierRepo::class, SupplierRepoImpl::class);
        $this->app->bind(SupplierPaymentRepo::class, SupplierPaymentRepoImpl::class);
